...
contract BlockReward is EternalStorage {
    ...
    function reward(address[] benefactors, uint16[] kind) external onlySystem returns (address[], uint256[], uint16) {
        ...
        return (receivers, rewards, dummyCounter);
    }
