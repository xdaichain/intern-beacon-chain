...
namespace Nethermind.Cli.Modules
{
    ...
    public class EthCliModule : CliModuleBase
    {
        ...
        [CliFunction("eth", "getContractStorage")]
        public string? GetContractStorage(string address, string? blockParameter = null)
        {
            return NodeManager.Post<string>("eth_getContractStorage", CliParseAddress(address), blockParameter ?? "latest").Result;
        }
