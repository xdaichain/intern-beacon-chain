...
namespace Nethermind.JsonRpc.Modules.Eth
{
    ...
    public interface IEthRpcModule : IRpcModule
    {
        ...
        [JsonRpcMethod(IsImplemented = true,
            Description = "Logs the whole storage for the contract to the file", 
            IsSharable = true, 
            ExampleResponse = "Hardcoded filename")]
        ResultWrapper<string> eth_getContractStorage(Address accountAddress, BlockParameter blockParameter);
